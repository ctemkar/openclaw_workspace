#!/usr/bin/env python3
"""
CLEAR ALL BINANCE FUTURES POSITIONS - AUTO CLOSE
"""
...
print("💰 CLOSING ALL BINANCE FUTURES POSITIONS (AUTO)")
print("="*60)
...
try:
    ...
    print("\n" + "="*60)
    print("🚀 AUTO-CLOSING ALL POSITIONS (START FROM SCRATCH)")
    print("="*60)
    
    print(f"\n⚡ CLOSING {len(open_positions)} POSITIONS (P&L: ${total_pnl:.4f})...")
...
print("\n" + "="*60)
print("✅ Binance cleared for fresh start!")
print("="*60)