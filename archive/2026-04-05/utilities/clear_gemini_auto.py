#!/usr/bin/env python3
"""
CLEAR ALL GEMINI HOLDINGS - AUTO CONFIRM
"""
...
print("💰 CLEARING ALL GEMINI HOLDINGS (AUTO)")
print("="*60)
...
try:
    ...
    for currency, amount in balance['total'].items():
        if amount > 0.00000001:  # Ignore tiny amounts
    ...
    print("\n" + "="*60)
    print("🚀 AUTO-SELLING ALL HOLDINGS (START FROM SCRATCH)")
    print("="*60)
    
    print(f"\n⚡ SELLING {len(holdings)} HOLDINGS (${total_value:.2f})...")
...
print("\n" + "="*60)
print("✅ Gemini cleared for fresh start!")
print("="*60)