            ...
            <div class="exchange-total">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div>
                        ...
                        <div class="investment-value gemini-value">
            ...
            <div class="exchange-total">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div>
                        ...
                        <div class="investment-value binance-value">
...
def load_exchange_holdings(exchange_name):
    """Load REAL holdings for a specific exchange - Match exchange reality"""
    holdings = []
    ...
    try:
        ...
        # Get REAL spot trades for this exchange (filter out test entries)
        exchange_trades = []
        for trade in trades:
            ...
            # Heuristic: Real trades have realistic market prices
            is_real_trade = True
            
            # Check for test indicators
            if 'price fixed' in note or 'amount fixed' in note:
                is_real_trade = False
                print(f"   ⚠️ Filtered out test entry: {symbol} @ ${price} (note: {note[:50]}...)")
            
            # Check for unrealistic prices (test entries)
            elif symbol == 'SOL/USD' and price > 100:  # SOL over $100 is suspicious
                is_real_trade = False
                print(f"   ⚠️ Filtered out suspicious SOL price: ${price} (market is ~$80)")
            elif symbol == 'BTC/USD' and price > 70000:  # BTC over $70k is suspicious
                is_real_trade = False
                print(f"   ⚠️ Filtered out suspicious BTC price: ${price} (market is ~$65k)")
            
            if is_real_trade:
                exchange_trades.append(trade)
        
        print(f"📊 {exchange_name.upper()}: Found {len(exchange_trades)} REAL spot trades")
