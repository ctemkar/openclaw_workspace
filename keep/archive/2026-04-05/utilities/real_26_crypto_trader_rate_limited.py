...
# REMOVED MAX_POSITIONS - Take every valid opportunity for aggressive trading
...
def execute_gemini_trade(exchange, trade_data):
    """Execute REAL Gemini LONG trade with LIMIT orders"""
    # Add small delay to avoid nonce errors
    time.sleep(0.5)  # 500ms delay between Gemini API calls
