#!/usr/bin/env python3
"""
START TRADING WITH P&L SUMMARY
...
def start_bots():
    ...
    with open('real_26_crypto_trader.log', 'w') as log_file:
    ...
    with open('fixed_bot_common.log', 'w') as log_file:
...
def main():
    ...
    # 2. Start bots
    input('\nPress Enter to start bots with 1.0% thresholds...')
    print()
